...
const account2 = {
  ...
  movementsDates: [
    ...
    '2020-07-18T16:33:06.386Z',
    '2020-07-22T14:43:26.374Z',
    '2020-07-21T18:49:59.371Z',
    '2020-06-20T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const formattedMovementDate = function (date) {
...
console.log(Math.max('5', '18', '23', 11, 2));
console.log(Math.max('5px', '18', '23px', 11, 2));

console.log(Math.min(5, 18, 23, 11, 2));
console.log(Math.min('5', '18', '23', 11, 2));
console.log(Math.min('5px', '18', '23px', 11, 2));
...
/* creating Dates 
There are 4 ways in javascript , using which we can create Dates
*/
...
// 2
console.log(new Date('October 16 , 2021'));

// In JS months are zero based , so   0 means January , 10 means november
// new Date(Year , Month, Day , Hours,min,sec)
console.log(new Date(2037, 10, 19, 15, 23, 5));
console.log(new Date(2040, 10, 31));

console.log(new Date(0));
// excatly 3 days after JAN-1
...
console.log(new Date(1626802372363));
...
console.log(new Intl.DateTimeFormat('en-US', options).format(todayDate));
